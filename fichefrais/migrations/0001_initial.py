...
import fichefrais.models.PieceJointe
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('etat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fichefrais.Etat')),
                ('fiche_frais', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fichefrais.FicheFrais')),
                ('frais_forfait', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='forfait', to='fichefrais.Forfait')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_ajout', models.DateField(auto_now_add=True)),
                ('date_modification', models.DateField(auto_now=True)),
                ('piece', models.FileField(blank=True, null=True, upload_to=fichefrais.models.PieceJointe.user_directory_path)),
                ('fiche_frais', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fichefrais.FicheFrais')),
            ],
        ),
    ]
